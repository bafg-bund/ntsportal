...
test_that("A dummy record can be added to msrawfiles", {
  ...
  pathResult <- elastic::Search(escon, indexName, source = "path", body = list(query = list(regexp = list(path = ".*msrawfiles-addRecord/RH_pos_20220603_no_peaks_test_addRecord.mzXML"))))$hits$hits[[1]][["_source"]]$path
