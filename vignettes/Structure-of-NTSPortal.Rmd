...
## Exceptions
For the index types `msrawfiles` and `spectral_library` there is only one index and there is no alias, so are just called `ntsp25.1_msrawfiles` or `ntsp25.1_spectral_library`.
...
|ntsp25.1_spectral_library|-|ntsp25.1_spectral_library*|
...
|ntsp25.1_index_test_dbas_v250408101520_bfg|ntsp25.1_test_dbas_bfg|ntsp25.1_test_dbas*|
