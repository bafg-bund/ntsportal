...
The Elasticsearch search API is available in the Dev Tools console in Kibana or via the API at `elastic.bafg.de`.  Refer to the extensive [documentation for Query DSL](https://www.elastic.co/guide/en/elasticsearch/reference/current/query-dsl.html). For the NTSPortal schema, see [Structure of NTSPortal](Structure-of-NTSPortal).
